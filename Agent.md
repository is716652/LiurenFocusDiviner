...
>   ⑤ **剧情演绎真机试玩**（§11 A 类第 7 条）：4 案 4 玩法是不是真不重样、点盘顺不顺手、断语闷不闷。
...
> 本文档更新前 main HEAD：`0fb811a 门禁: 同课异占只能是「自由取象」+ 白名单案强制已挂`
...
**A. 需要用户（真机 / 目视 / 拍板）** —— 2026-09-25 状态：**1.0.6 已上架**；三项已确认 + 一条阈值待拍板；
未结项 = 第 2 条④（杀进程重开）、第 5 条（层间阈值）、第 6 条（古籍挂账 4 项）与新增的第 7 条（剧情演绎试玩）。
